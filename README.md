...
- [BreakShield CI](https://github.com/apps/breakshield-ci) - GitHub App that catches breaking API changes in PRs using TypeScript AST. Risk scoring and AI auto-fix.
